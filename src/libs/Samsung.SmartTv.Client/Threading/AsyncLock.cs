...
namespace Samsung.SmartTv.Client.Threading
{
    /// <summary>
    /// AsyncLock from https://github.com/neosmart/AsyncLock 
    /// Copied as a code in order to avoid adding large number of packages that happens when library referenced in nestandard2.1 project. 
    /// </summary>
